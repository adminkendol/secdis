...
/**
 * Created by Chandra on 9/11/2016.
 */
public abstract class Infoserver extends Fragment{
    ...
    @SuppressLint("NewApi")
    public abstract void onValueSelected(Entry e, int dataSetIndex, Highlight h);
}
